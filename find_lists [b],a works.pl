...
%find_lists([T,A,B,C],L1,L2,Start,TN1,TN2) :-
% get_lang_word("t",T), 
%!,find_lists([[T,A,B,C]],L1,L2,Start,TN1,TN2).
...
%trace,
 ...
 %trace,
 (false%L32=[[[T, _Dbw_list]|_]|_]
 ->
 foldr(append,L32,L322);(%trace,
 L32=L322)),
 %L32=[L322],
 foldr(append,[[[T,Dbw_list]],[L322]],L311),%notrace,
 L31=L311,
 %foldr(append,[L311],L31)
(%trace,
false
 %L1=[[T, _,_,_]|_]
 ->L12=[L1];L12=L1),
 
 foldr(append,[L12,[L31]],L2));
 (B=brackets2->(
 (L3=[[T, _,_,_]|_]->L32=[L3];L32=L3),
 (L32=[[[T, Dbw_list]|_]|_]->
 foldr(append,L32,L322);L32=L322),
 foldr(append,[[[T,Dbw_list]],L322],L311),
 L31=L311,
(false%trace,
 %L1=[[T, _,_,_]|_]
 ->L12=[L1];L12=L1),
...
check_same(A,B,L1,L2,_Start,TN1,TN2) :-
 ...
 ((%trace,
 false%L1=[[T, _,_,_]|_]
 ->L12=[L1];L12=L1),%notrace,
 foldr(append,[L12,[L3]],L4))),
 (false%trace,
 %T22=[T, _,_,_]
 ->T23=[T22];T23=T22),
 append(T12,T23,T12T22),
...
check_same2(TL14,TL17,L1,L2,Start,TN1,TN2) :-
 ...
 (false%trace,
 %TL152=[T, _,_,_]
 ->TL1521=[TL152];TL1521=TL152),
 append(TL142,TL1521,TL142TL152),
 find_lists(TL142TL152,[],L4,Start,TN3,TN4),
 (L4=[T, _,_,_]->L41=[L4];L41=L4),
 append(L3,L41,L5),
 %trace,
 %append(TL17,))
 (TL16=[]->(L5=L2,TN4=TN2);
