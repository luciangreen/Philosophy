...
(member(Number,Numbers),random_member(Type,[fill_the_gap,
...
get_extra_answers(Worksheet_plan2,[],Worksheet_plan3),
...
get_extra_answers(Text,Worksheet_plan1,Worksheet_plan2,Worksheet_plan3) :-
 ...
 findall(Answers1,member([_,Answers]),Answers2),
 get_extra_answers2(Text,Extra_answers1,Answers2,Answers3));Answers3=[]),
