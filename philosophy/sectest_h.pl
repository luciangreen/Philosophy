...
sectest_h(Person):-
	...
	writeln([Person,H,M,S,Threats1,humour]).
	%,Threats2,no_death]).
	
find_time1(H,M,S) :-
	find_time(H,M,S),!.

humour(Threats1,Threats2):-
	...
	(Answer="No"->Threats2=Threats1;(Threats3 is Threats1+1,humour(Threats3,Threats2))),!.
