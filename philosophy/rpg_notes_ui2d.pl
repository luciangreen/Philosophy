...
traverse(X,Y,Explored1,Explored2,Inventory1,Inventory2,Map1,Map2) :-
	...
	writeln(["Go",Directions6,"or take",Cell,"or drop",Inventory1,"map, write, edit or delete a note, or load or save a game."]),
	...
	%trace,
	map_dimensions([X2,Y2]),print_map(Map1,X2,Y2,X,Y))->true;
...
%read_string(user_input, "\n", "\r", _End2, Note),
append(Cell,[First_item],Cell2),delete(Map1,[X,Y,_],Map3),append(Map3,[[X,Y,Cell2]],Map4))->(writeln(["You have written",First_item]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map4,Map2));(writeln(["Error 1."]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map1,Map2))))->true;
...
read_string(user_input, "\n", "\r", _End2, Note),
%trace,
delete(Cell,First_item,Cell2a),append(Cell2a,[Note],Cell2),delete(Map1,[X,Y,_],Map3),append(Map3,[[X,Y,Cell2]],Map4))->(writeln(["You have edited",First_item]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map4,Map2));(writeln(["You can't edit",First_item]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map1,Map2))))->true;
...
delete(Map1,[X,Y,_],Map3),append(Map3,[[X,Y,Cell2]],Map4))->(writeln(["You have deleted",First_item]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map4,Map2));(writeln(["Error 3."]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map1,Map2))))->true;
...
%delete(Cell,First_item,Cell2),
%delete(Map1,[X,Y,_],Map3),append(Map3,[[X,Y,Cell2]],Map4)
)->(writeln(["You have loaded",First_item]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map4,Map2));(writeln(["Error 4."]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map1,Map2))))->true;
...
%delete(Cell,First_item,Cell2),
%delete(Map1,[X,Y,_],Map3),append(Map3,[[X,Y,Cell2]],Map4)
)->(writeln(["You have saved",First_item]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map1,Map2));(writeln(["Error 5."]),traverse(X,Y,Explored3,Explored2,Inventory1,Inventory2,Map1,Map2))))->true;
