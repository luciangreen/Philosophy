...
* Run generated algorithms by uncommenting the first line in and loading <a href="https://github.com/luciangreen/Philosophy/blob/master/s2a/auxiliary_s2a2.pl">auxiliary_s2a2.pl</a> and calling `algorithm(In_vars,Out_var).` Please check the name of the algorithm.
