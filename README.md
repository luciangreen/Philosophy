...
* Run generated algorithms by loading the algorithm (ensuring that `\"` has been replaced with `"`),<a href="https://github.com/luciangreen/Philosophy/blob/master/s2a/auxiliary_s2a2.pl">auxiliary_s2a2.pl</a> and <a href="https://github.com/luciangreen/Philosophy/blob/master/s2a/auxiliary_s2a_used.pl">auxiliary_s2a_used.pl</a> and calling `algorithm(In_vars,Out_var).` with the correct In_vars. Please check the name of the algorithm.
