...
% ../../../../../../Applications/SWI-Prolog.app/Contents/MacOS/SWI-Prolog -f -q day2_app.pl
% main.
...
(
foldr(string_concat,["../../../../../../Applications/SWI-Prolog.app/Contents/MacOS/SWI-Prolog -f -q ./bag_args21.pl"],S3)%,
...
%/*
(
foldr(string_concat,["../../../../../../Applications/SWI-Prolog.app/Contents/MacOS/SWI-Prolog -f -q ./bag_algs1.pl"],S31)%,
